  ...
  const teamMembers = [
    {
      ...
      description:
        "Co-Director of Stanford Human-Centered AI Institute, world leader in AI education and research, TED speaker, and advocate for accessible technology.",
    },
    {
      name: "Dr. Eric Mazur",
      role: "Student Engagement Lead",
      description:
        "Balkanski Professor of Physics and Applied Physics at Harvard, pioneer in peer instruction and active learning, globally recognized education innovator.",
    },
    {
      name: "Dr. Ngozi Okonjo-Iweala",
      role: "Faculty Relations Manager",
      description:
        "Director-General of the World Trade Organization, former Finance Minister of Nigeria, champion for global education and sustainable development.",
    },
  ];
  ...
  const trustPoints = [
    {
      ...
      description:
        "Every seminar features verified industry leaders, renowned academics, and successful professionals with proven track records.",
    },
    {
      icon: <TrendingUp className="w-12 h-12 text-blue-500" />,
      title: "Measurable Results",
      description:
        "85% of attendees report concrete career advancement within 6 months, including scholarships, job offers, and research opportunities.",
    },
    {
      icon: <Globe className="w-12 h-12 text-purple-500" />,
      title: "Global Network",
      description:
        "Connect with ambitious peers and mentors across 50+ countries, building relationships that last beyond the seminars.",
    },
  ];
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-24 text-center text-white">
          ...
          <div className="flex flex-wrap justify-center gap-4 mt-10">
            {[
              ...
              <div
                key={index}
                className="flex items-center bg-white/10 backdrop-blur-sm px-6 py-3 rounded-full border border-white/20 hover:bg-white/20 transition-all duration-300"
              >
